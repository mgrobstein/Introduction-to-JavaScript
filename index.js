...
*/
let oneThousandNineHundredNintyNine = "1999";
console.log(Number(oneThousandNineHundredNintyNine))
...
function annoyingSong(bottlesOfSoda){
  for (let i=0;i<bottlesOfSoda;i++){
  let currentBottles = bottlesOfSoda;
  bottlesOfSoda --;
 return currentBottles+" bottles of soda on the wall, "+currentBottles+" bottles of soda, take one down pass it around "+bottlesOfSoda+" bottles of soda on the wall"
}
}
